...
const CARD_BACK = 'https://cdn.retrostylemedia.co.uk/media/img_56d36ee73b7c9.jpg';
...
function render() {
  // renderControls();
  moreMatchesBtn.style.visibility = winner || countBad > 8 ? 'visible' : 'hidden';
  cards.forEach(function (card, idx) {
    ...
    msgEl.innerHTML = `Wrong Disc: ${countBad}`;
    getWinner();
  });
}
